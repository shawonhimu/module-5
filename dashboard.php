...
} else if ($_SESSION['status'] == 'manager' && $_SESSION['email']) {
    header('location:manager.php');
} else if ($_SESSION['status'] == 'user' && $_SESSION['email']) {
...
?>
        ...
        <div class="adminContent">
            ...
            <div class="dashboard-card">
                <div>
                    <a class="btn btn-warning" href="addnew.php" >Add New Role</a>
                </div>
                <hr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href='delete.php?data=<?php echo urlencode($key); ?>'>Delete</a>
                                </td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
